...
from generate_true_concentration.gen_true_slope_init_conc import get_site_source_conc, reduction



def plot_variable_mrt(base_site):
    ...
    fig.suptitle(f'Affect of MRT on detection power at {base_site}')
