...
\begin{itemize}
    ...
    \item If we assume that dairy farms only make up 50\% of every source area then we would only expect decreasing \gls{no3n} concentrations in 52\% of monitoring wells.
