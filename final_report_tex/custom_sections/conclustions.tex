...
\begin{itemize}
    \item The monitoring design framework presented in \citet{olw_guidance} report should be applied to the Selwyn Waihora catchment. % todo start revieing here
