...
\autoref{fig:plateau_locs} shows the location of these plateau sites and at and the maximum nitrate loss reduction at which concentrations will plateau. % todo flip to will show a decreasing trend at >= 5% reduction
...
%todo include breakaway or similar about how MRT is used.
...
%todo how many sites quarterly or greater (breakaway box?)
